...
export class MainComponent extends React.Component<Props, State> {
    ...
    render() {
        const ContentComponent = getComponentFromMenuItem(this.state.selectedMenuItem);
        return (
            <div class="main-component">
                ...
                <FooterComponent selectedMenuItem={this.state.selectedMenuItem} onMenuItemSelect={(item: string) => this.selectMenuItem(item)}/>
            </div>);
    }
}